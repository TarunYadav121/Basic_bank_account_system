...
public class UserInterface {
    ...
    private void createAccount() {                                              //for creating new account 
        ...
        //FOR LINE NUMBER 83 TO 86 : Creates a brand-new Account object using the values you pass (name, initialDeposit, email, phone).accounts[accountCount++]:This is where the new Account will be stored in the array.AccountCount is the current number of accounts already stored.
